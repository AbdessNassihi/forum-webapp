    ...
    const handleCommentSubmit = async (e) => {
        ...
        try {
            ...
            if (response.status === 201) {
                ...
                toast.error('Failed to post comment. Please try again later.', { hideProgressBar: true, autoClose: 2000 });
            }
        } catch (error) {
            toast.error('An error occurred while posting the comment.', { hideProgressBar: true, autoClose: 2000 });
        }
    };
