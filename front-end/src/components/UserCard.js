...
const UserCardComponent = ({ username }) => {
        ...
        const fetchUserData = async () => {
            if (user) {
                try {
                    ...
                    toast.error('A server error occurred', { hideProgressBar: true, autoClose: 2000 });
                } finally {
    ...
    const handleSetAdmin = async () => {
        try {
            ...
            if (response.status === 200) {
                ...
                toast.success('User set as admin successfully', { hideProgressBar: true, autoClose: 2000 });
            } else {
